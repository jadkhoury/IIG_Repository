...
// TO DO
// - prono-supination according to target orientation around forearm alligned axis
// 

public class IKLimb: MonoBehaviour {
	// references to limb joints
	public Transform upperArm, forearm, hand;
	// end effector and middle joint targets
	...
	// end effector orientation is defined by:
	public enum HandRotations {
		KeepLocalRotation,
		KeepGlobalRotation,
		UseTargetRotation,
		CombineStartAndTarget
	};
	public HandRotations handRotationPolicy = HandRotations.KeepLocalRotation;
	
	// to keep the original orientation of the joints
	private Quaternion upperArmStartRotation, forearmStartRotation, handStartRotation, handStartLocalRotation;
	...
	void Start(){
		...
		handStartLocalRotation = hand.localRotation;
	...
	void CalculateIK(){
		...
		case HandRotations.UseTargetRotation:
			...
			break;
		case HandRotations.CombineStartAndTarget:
			hand.localRotation = handStartLocalRotation * Quaternion.Inverse(target.localRotation);			
